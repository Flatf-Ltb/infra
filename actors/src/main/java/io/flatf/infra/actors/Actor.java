...
import io.flatf.infra.actors.impl.IActorSystem;
...
public class Actor {
     ...
     */
    public static io.flatf.infra.actors.IActorSystem newSystem(String name) {
     ...
     * @return newly created actor system
     */
    public static io.flatf.infra.actors.IActorSystem newSystem(String name, IActorScheduler defaultScheduler) {
     ...
     */
    public static io.flatf.infra.actors.IActorSystem system() {
