...
import io.flatf.actors.impl.IActorSystem;
...
public class Actor {
     ...
     */
    public static io.flatf.actors.IActorSystem newSystem(String name) {
     ...
     * @return newly created actor system
     */
    public static io.flatf.actors.IActorSystem newSystem(String name, IActorScheduler defaultScheduler) {
     ...
     */
    public static io.flatf.actors.IActorSystem system() {
