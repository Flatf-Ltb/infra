...
public class AvroBinaryMsg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AvroBinaryMsg(io.flatf.infra.serialization.avro.msg.Envelope envelope, java.lang.Long sequence, java.lang.Long epoch, java.nio.ByteBuffer content) {
   ...
   */
  public AvroBinaryMsg setEnvelope(io.flatf.infra.serialization.avro.msg.Envelope value) {
    this.envelope = value;
    return this;
  }
   ...
   */
  public static io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder newBuilder() {
    return new io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder();
  }
   ...
   * @return A new AvroBinaryMsg RecordBuilder
   */
  public static io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder newBuilder(io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder other) {
    if (other == null) {
      return new io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder();
    } else {
      return new io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder(other);
    }
  }
   ...
   * @return A new AvroBinaryMsg RecordBuilder
   */
  public static io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder newBuilder(io.flatf.infra.serialization.avro.msg.AvroBinaryMsg other) {
    if (other == null) {
      return new io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder();
    } else {
      return new io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroBinaryMsg>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.flatf.infra.serialization.avro.msg.AvroBinaryMsg other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.envelope)) {
        this.envelope = data().deepCopy(fields()[0].schema(), other.envelope);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder setEnvelope(io.flatf.infra.serialization.avro.msg.Envelope value) {
    ...
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder setEnvelopeBuilder(io.flatf.infra.serialization.avro.msg.Envelope.Builder value) {
      clearEnvelope();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder clearEnvelope() {
      envelope = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder setSequence(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder clearSequence() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder setEpoch(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder clearEpoch() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder setContent(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.infra.serialization.avro.msg.AvroBinaryMsg.Builder clearContent() {
      content = null;
