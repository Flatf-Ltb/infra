...
import io.flatf.infra.serialization.avro.msg.AvroBinaryMsg;
import io.flatf.infra.serialization.avro.msg.AvroTextMsg;
import io.flatf.infra.serialization.avro.msg.ContentType;
...
public final class AvroMsgWrapper {
    ...
    /**
     * @param envelope io.flatf.infra.serialization.avro.msg.Envelope
     * @param content  ByteBuffer
     * @return AvroBinaryMsg
     */
    public static AvroBinaryMsg wrap(io.flatf.infra.serialization.avro.msg.Envelope envelope,
                                     ByteBuffer content) {
     ...
     * @return AvroTextMsg
     */
    public static AvroTextMsg wrap(io.flatf.infra.serialization.avro.msg.Envelope envelope,
                                   String content) {
        return wrap(envelope, EpochSequence.allocate(), System.currentTimeMillis(), content);
    }
    ...
    public static AvroBinaryMsg wrap(Envelope envelope,
        ...
        return AvroBinaryMsg.newBuilder()
                .setEnvelope(io.flatf.infra.serialization.avro.msg.Envelope.newBuilder().setCode(envelope.getCode())
