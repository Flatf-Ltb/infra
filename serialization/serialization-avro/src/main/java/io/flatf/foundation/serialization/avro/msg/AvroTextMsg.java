 ...
 */
package io.flatf.foundation.serialization.avro.msg;
...
public class AvroTextMsg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private io.flatf.foundation.serialization.avro.msg.Envelope envelope;
   ...
   */
  public AvroTextMsg(io.flatf.foundation.serialization.avro.msg.Envelope envelope, java.lang.Long sequence, java.lang.Long epoch, java.lang.String content) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: envelope = (io.flatf.foundation.serialization.avro.msg.Envelope)value$; break;
   ...
   */
  public io.flatf.foundation.serialization.avro.msg.Envelope getEnvelope() {
    return envelope;
  }
   ...
   */
  public AvroTextMsg setEnvelope(io.flatf.foundation.serialization.avro.msg.Envelope value) {
    this.envelope = value;
    return this;
  }
   ...
   */
  public static io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder newBuilder() {
    return new io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder();
  }
   ...
   * @return A new AvroTextMsg RecordBuilder
   */
  public static io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder newBuilder(io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder other) {
    if (other == null) {
      return new io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder();
    } else {
      return new io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder(other);
    }
  }
   ...
   * @return A new AvroTextMsg RecordBuilder
   */
  public static io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder newBuilder(io.flatf.foundation.serialization.avro.msg.AvroTextMsg other) {
    if (other == null) {
      return new io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder();
    } else {
      return new io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroTextMsg>
    ...
    private io.flatf.foundation.serialization.avro.msg.Envelope envelope;
    private io.flatf.foundation.serialization.avro.msg.Envelope.Builder envelopeBuilder;
    private long sequence;
    private long epoch;
    private java.lang.String content;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder other) {
      super(other);
      ...
      if (other.hasEnvelopeBuilder()) {
        this.envelopeBuilder = io.flatf.foundation.serialization.avro.msg.Envelope.newBuilder(other.getEnvelopeBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.flatf.foundation.serialization.avro.msg.AvroTextMsg other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.envelope)) {
        this.envelope = data().deepCopy(fields()[0].schema(), other.envelope);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder setEnvelope(io.flatf.foundation.serialization.avro.msg.Envelope value) {
     ...
     * @return This builder.
     */
    public io.flatf.foundation.serialization.avro.msg.Envelope.Builder getEnvelopeBuilder() {
      if (envelopeBuilder == null) {
        if (hasEnvelope()) {
          setEnvelopeBuilder(io.flatf.foundation.serialization.avro.msg.Envelope.newBuilder(envelope));
        } else {
          setEnvelopeBuilder(io.flatf.foundation.serialization.avro.msg.Envelope.newBuilder());
        }
      }
    ...
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder setEnvelopeBuilder(io.flatf.foundation.serialization.avro.msg.Envelope.Builder value) {
      clearEnvelope();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder clearEnvelope() {
      envelope = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder setSequence(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder clearSequence() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder setEpoch(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder clearEpoch() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder setContent(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.AvroTextMsg.Builder clearContent() {
      content = null;
    ...
    public AvroTextMsg build() {
      try {
        ...
        if (envelopeBuilder != null) {
          ...
          record.envelope = fieldSetFlags()[0] ? this.envelope : (io.flatf.foundation.serialization.avro.msg.Envelope) defaultValue(fields()[0]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.envelope == null) {
        this.envelope = new io.flatf.foundation.serialization.avro.msg.Envelope();
      }
