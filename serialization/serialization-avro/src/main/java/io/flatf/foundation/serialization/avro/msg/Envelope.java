...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6551175078618444283L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"io.flatf.foundation.serialization.avro.msg\",\"fields\":[{\"name\":\"code\",\"type\":\"int\"},{\"name\":\"version\",\"type\":\"int\"},{\"name\":\"contentType\",\"type\":{\"type\":\"enum\",\"name\":\"ContentType\",\"symbols\":[\"NULL\",\"BOOLEAN\",\"BYTE\",\"CHAR\",\"INT\",\"LONG\",\"DOUBLE\",\"STRING\",\"OBJECT\",\"LIST\",\"MAP\"]}}]}");
  ...
  private int code;
  private int version;
  private io.flatf.foundation.serialization.avro.msg.ContentType contentType;
   ...
   */
  public Envelope(java.lang.Integer code, java.lang.Integer version, io.flatf.foundation.serialization.avro.msg.ContentType contentType) {
    this.code = code;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: contentType = (io.flatf.foundation.serialization.avro.msg.ContentType)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public io.flatf.foundation.serialization.avro.msg.ContentType getContentType() {
    return contentType;
  }
   ...
   * @param value the value to set.
   */
  public Envelope setContentType(io.flatf.foundation.serialization.avro.msg.ContentType value) {
   ...
   */
  public static io.flatf.foundation.serialization.avro.msg.Envelope.Builder newBuilder() {
    return new io.flatf.foundation.serialization.avro.msg.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static io.flatf.foundation.serialization.avro.msg.Envelope.Builder newBuilder(io.flatf.foundation.serialization.avro.msg.Envelope.Builder other) {
    if (other == null) {
      return new io.flatf.foundation.serialization.avro.msg.Envelope.Builder();
    } else {
      return new io.flatf.foundation.serialization.avro.msg.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static io.flatf.foundation.serialization.avro.msg.Envelope.Builder newBuilder(io.flatf.foundation.serialization.avro.msg.Envelope other) {
    if (other == null) {
      return new io.flatf.foundation.serialization.avro.msg.Envelope.Builder();
    } else {
      return new io.flatf.foundation.serialization.avro.msg.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.flatf.foundation.serialization.avro.msg.Envelope.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.flatf.foundation.serialization.avro.msg.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.code)) {
        this.code = data().deepCopy(fields()[0].schema(), other.code);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.Envelope.Builder setCode(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.Envelope.Builder clearCode() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.Envelope.Builder setVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.Envelope.Builder clearVersion() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.Envelope.Builder setContentType(io.flatf.foundation.serialization.avro.msg.ContentType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.flatf.foundation.serialization.avro.msg.Envelope.Builder clearContentType() {
      contentType = null;
    ...
    public Envelope build() {
      try {
        ...
        record.contentType = fieldSetFlags()[2] ? this.contentType : (io.flatf.foundation.serialization.avro.msg.ContentType) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.contentType = io.flatf.foundation.serialization.avro.msg.ContentType.values()[in.readEnum()];
