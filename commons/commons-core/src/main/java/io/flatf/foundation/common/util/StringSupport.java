package io.flatf.foundation.common.util;
...
public final class StringSupport {
     ...
     */
    @Nonnull
    public static String toString(Charset charset, byte[] bytes) {
        if (bytes == null)
            return CONST_NULL;
        return new String(bytes, charset == null ? Charsets.UTF8 : charset);
    }
